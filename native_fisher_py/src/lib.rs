...
#[pyfunction]
fn get_num_scans(handle: i32) -> PyResult<i32> {
    let lib = get_lib()?;
    unsafe {
        let func: Symbol<unsafe extern "C" fn(i32) -> i32> = lib.get(b"get_num_scans")
...
#[pyfunction]
fn get_tune_data_count(handle: i32) -> PyResult<i32> {
    let lib = get_lib()?;
    unsafe {
        let func: Symbol<unsafe extern "C" fn(i32) -> i32> = lib.get(b"get_tune_data_count")
...
#[pyfunction]
fn get_scan_rt(handle: i32, scan_number: i32) -> PyResult<f64> {
    let lib = get_lib()?;
    unsafe {
        let func: Symbol<unsafe extern "C" fn(i32, i32) -> f64> = lib.get(b"get_scan_rt")
...
#[pyfunction]
fn get_spectrum(handle: i32, scan_number: i32, max_length: i32) -> PyResult<(Vec<f64>, Vec<f64>)> {
    let lib = get_lib()?;
    let mut masses = vec![0.0f64; max_length as usize];
    let mut intensities = vec![0.0f64; max_length as usize];
    
    unsafe {
        let func: Symbol<unsafe extern "C" fn(i32, i32, *mut f64, *mut f64, i32) -> i32> = lib.get(b"get_spectrum")
...
#[pyfunction]
fn is_centroid(handle: i32, scan_number: i32) -> PyResult<bool> {
    let lib = get_lib()?;
    unsafe {
        let func: Symbol<unsafe extern "C" fn(i32, i32) -> i32> = lib.get(b"is_centroid")
...
#[pyfunction]
fn get_centroid_stream(handle: i32, scan_number: i32, max_length: i32) -> PyResult<(Vec<f64>, Vec<f64>, Vec<f64>, Vec<f64>, Vec<i32>, f64, f64)> {
    let lib = get_lib()?;
    let mut masses = vec![0.0f64; max_length as usize];
    let mut intensities = vec![0.0f64; max_length as usize];
    ...
    unsafe {
        let func: Symbol<unsafe extern "C" fn(i32, i32, *mut f64, *mut f64, *mut f64, *mut f64, *mut i32, *mut f64, i32) -> i32> = 
        ...
        let actual_len = func(handle, scan_number, 
            masses.as_mut_ptr(), 
...
#[pyfunction]
fn get_sample_type(handle: i32) -> PyResult<i32> {
    let lib = get_lib()?;
    unsafe {
        let func: Symbol<unsafe extern "C" fn(i32) -> i32> = lib.get(b"get_sample_type")
...
#[pyfunction]
fn get_sample_row_number(handle: i32) -> PyResult<i32> {
    let lib = get_lib()?;
    unsafe {
        let func: Symbol<unsafe extern "C" fn(i32) -> i32> = lib.get(b"get_sample_row_number")
...
#[pyfunction]
fn get_sample_dilution_factor(handle: i32) -> PyResult<f64> {
    let lib = get_lib()?;
    unsafe {
        let func: Symbol<unsafe extern "C" fn(i32) -> f64> = lib.get(b"get_sample_dilution_factor")
...
#[pyfunction]
fn get_first_scan(handle: i32) -> PyResult<i32> {
    let lib = get_lib()?;
    unsafe {
        let func: Symbol<unsafe extern "C" fn(i32) -> i32> = lib.get(b"get_first_scan")
...
#[pyfunction]
fn get_last_scan(handle: i32) -> PyResult<i32> {
    let lib = get_lib()?;
    unsafe {
        let func: Symbol<unsafe extern "C" fn(i32) -> i32> = lib.get(b"get_last_scan")
...
#[pyfunction]
fn get_end_time(handle: i32) -> PyResult<f64> {
    let lib = get_lib()?;
    unsafe {
        let func: Symbol<unsafe extern "C" fn(i32) -> f64> = lib.get(b"get_end_time")
...
#[pyfunction]
fn get_start_time(handle: i32) -> PyResult<f64> {
    let lib = get_lib()?;
    unsafe {
        let func: Symbol<unsafe extern "C" fn(i32) -> f64> = lib.get(b"get_start_time")
...
#[pyfunction]
fn get_mass_resolution(handle: i32) -> PyResult<f64> {
    let lib = get_lib()?;
    unsafe {
        let func: Symbol<unsafe extern "C" fn(i32) -> f64> = lib.get(b"get_mass_resolution")
...
#[pyfunction]
fn get_expected_runtime(handle: i32) -> PyResult<f64> {
    let lib = get_lib()?;
    unsafe {
        let func: Symbol<unsafe extern "C" fn(i32) -> f64> = lib.get(b"get_expected_runtime")
...
#[pyfunction]
fn get_max_integrated_intensity(handle: i32) -> PyResult<f64> {
    let lib = get_lib()?;
    unsafe {
        let func: Symbol<unsafe extern "C" fn(i32) -> f64> = lib.get(b"get_max_integrated_intensity")
...
#[pyfunction]
fn get_max_intensity(handle: i32) -> PyResult<i32> {
    let lib = get_lib()?;
    unsafe {
        let func: Symbol<unsafe extern "C" fn(i32) -> i32> = lib.get(b"get_max_intensity")
...
#[pyfunction]
fn get_low_mass(handle: i32) -> PyResult<f64> {
    let lib = get_lib()?;
    unsafe {
        let func: Symbol<unsafe extern "C" fn(i32) -> f64> = lib.get(b"get_low_mass")
...
#[pyfunction]
fn get_high_mass(handle: i32) -> PyResult<f64> {
    let lib = get_lib()?;
    unsafe {
        let func: Symbol<unsafe extern "C" fn(i32) -> f64> = lib.get(b"get_high_mass")
...
#[pyfunction]
fn get_file_name(handle: i32) -> PyResult<String> {
    let lib = get_lib()?;
    let mut buffer = vec![0u8; 1024];
    unsafe {
        let func: Symbol<unsafe extern "C" fn(i32, *mut u8, i32) -> i32> = lib.get(b"get_file_name")
...
#[pyfunction]
fn get_path(handle: i32) -> PyResult<String> {
    let lib = get_lib()?;
    let mut buffer = vec![0u8; 1024];
    unsafe {
        let func: Symbol<unsafe extern "C" fn(i32, *mut u8, i32) -> i32> = lib.get(b"get_path")
...
#[pyfunction]
fn get_creation_date(handle: i32) -> PyResult<String> {
    let lib = get_lib()?;
    let mut buffer = vec![0u8; 256];
    unsafe {
        let func: Symbol<unsafe extern "C" fn(i32, *mut u8, i32) -> i32> = lib.get(b"get_creation_date")
...
#[pyfunction]
fn get_computer_name(handle: i32) -> PyResult<String> {
    let lib = get_lib()?;
    let mut buffer = vec![0u8; 256];
    unsafe {
        let func: Symbol<unsafe extern "C" fn(i32, *mut u8, i32) -> i32> = lib.get(b"get_computer_name")
...
#[pyfunction]
fn get_creator_id(handle: i32) -> PyResult<String> {
    let lib = get_lib()?;
    let mut buffer = vec![0u8; 256];
    unsafe {
        let func: Symbol<unsafe extern "C" fn(i32, *mut u8, i32) -> i32> = lib.get(b"get_creator_id")
...
#[pyfunction]
fn get_instrument_model(handle: i32) -> PyResult<String> {
    let lib = get_lib()?;
    let mut buffer = vec![0u8; 1024];
    unsafe {
        let func: Symbol<unsafe extern "C" fn(i32, *mut u8, i32) -> i32> = lib.get(b"get_instrument_model")
...
#[pyfunction]
fn get_instrument_name(handle: i32) -> PyResult<String> {
    let lib = get_lib()?;
    let mut buffer = vec![0u8; 1024];
    unsafe {
        let func: Symbol<unsafe extern "C" fn(i32, *mut u8, i32) -> i32> = lib.get(b"get_instrument_name")
...
#[pyfunction]
fn get_instrument_serial_number(handle: i32) -> PyResult<String> {
    let lib = get_lib()?;
    let mut buffer = vec![0u8; 1024];
    unsafe {
        let func: Symbol<unsafe extern "C" fn(i32, *mut u8, i32) -> i32> = lib.get(b"get_instrument_serial_number")
...
#[pyfunction]
fn get_instrument_software_version(handle: i32) -> PyResult<String> {
    let lib = get_lib()?;
    let mut buffer = vec![0u8; 1024];
    unsafe {
        let func: Symbol<unsafe extern "C" fn(i32, *mut u8, i32) -> i32> = lib.get(b"get_instrument_software_version")
...
#[pyfunction]
fn get_instrument_hardware_version(handle: i32) -> PyResult<String> {
    let lib = get_lib()?;
    let mut buffer = vec![0u8; 1024];
    unsafe {
        let func: Symbol<unsafe extern "C" fn(i32, *mut u8, i32) -> i32> = lib.get(b"get_instrument_hardware_version")
...
#[pyfunction]
fn get_ms_order(handle: i32, scan_number: i32) -> PyResult<i32> {
    let lib = get_lib()?;
    unsafe {
        let func: Symbol<unsafe extern "C" fn(i32, i32) -> i32> = lib.get(b"get_ms_order")
...
#[pyfunction]
fn get_mass_analyzer(handle: i32, scan_number: i32) -> PyResult<i32> {
    let lib = get_lib()?;
    unsafe {
        let func: Symbol<unsafe extern "C" fn(i32, i32) -> i32> = lib.get(b"get_mass_analyzer")
...
#[pyfunction]
fn get_precursor_mass(handle: i32, scan_number: i32) -> PyResult<f64> {
    let lib = get_lib()?;
    unsafe {
        let func: Symbol<unsafe extern "C" fn(i32, i32) -> f64> = lib.get(b"get_precursor_mass")
...
#[pyfunction]
fn get_scan_event_string(handle: i32, scan_number: i32) -> PyResult<String> {
    let lib = get_lib()?;
    let mut buffer = vec![0u8; 1024];
    unsafe {
        let func: Symbol<unsafe extern "C" fn(i32, i32, *mut u8, i32) -> i32> = lib.get(b"get_scan_event_string")
...
#[pyfunction]
fn get_scan_filter_string(handle: i32, scan_number: i32) -> PyResult<String> {
    let lib = get_lib()?;
    let mut buffer = vec![0u8; 1024];
    unsafe {
        let func: Symbol<unsafe extern "C" fn(i32, i32, *mut u8, i32) -> i32> = lib.get(b"get_scan_filter_string")
...
#[pyfunction]
fn get_scan_number_from_rt(handle: i32, rt: f64) -> PyResult<i32> {
    let lib = get_lib()?;
    unsafe {
        let func: Symbol<unsafe extern "C" fn(i32, f64) -> i32> = lib.get(b"get_scan_number_from_rt")
...
#[pyfunction]
fn get_ms2_filter_masses(handle: i32, max_size: i32) -> PyResult<Vec<f64>> {
    let lib = get_lib()?;
    let mut buffer = vec![0.0f64; max_size as usize];
    unsafe {
        let func: Symbol<unsafe extern "C" fn(i32, *mut f64, i32) -> i32> = lib.get(b"get_ms2_filter_masses")
...
#[pyfunction]
fn get_ms2_scan_number_from_rt(handle: i32, rt: f64, precursor_mz: f64, tolerance_ppm: f64) -> PyResult<i32> {
    let lib = get_lib()?;
    unsafe {
        let func: Symbol<unsafe extern "C" fn(i32, f64, f64, f64) -> i32> = lib.get(b"get_ms2_scan_number_from_rt")
...
#[pyfunction]
fn get_ms1_scan_number_from_rt(handle: i32, rt: f64) -> PyResult<i32> {
    let lib = get_lib()?;
    unsafe {
        let func: Symbol<unsafe extern "C" fn(i32, f64) -> i32> = lib.get(b"get_ms1_scan_number_from_rt")
...
#[pyfunction]
fn get_chromatogram(handle: i32, trace_type: i32, filter: String, mass_ranges_start: Vec<f64>, mass_ranges_end: Vec<f64>, start_scan: i32, end_scan: i32, max_length: i32) -> PyResult<(Vec<f64>, Vec<f64>)> {
    let lib = get_lib()?;
    ...
    unsafe {
        let func: Symbol<unsafe extern "C" fn(i32, i32, *const std::os::raw::c_char, *const f64, *const f64, i32, i32, i32, *mut f64, *mut f64, i32) -> i32> = lib.get(b"get_chromatogram")
...
#[pyfunction]
fn get_filters(handle: i32) -> PyResult<Vec<String>> {
    let lib = get_lib()?;
    let mut filters = vec![std::ptr::null_mut(); 1024];
    unsafe {
        let func: Symbol<unsafe extern "C" fn(i32, *mut *mut std::os::raw::c_char, i32) -> i32> = lib.get(b"get_filters")
...
#[pyfunction]
fn get_averaged_spectrum(handle: i32, scan_numbers: Vec<i32>, max_length: i32) -> PyResult<(Vec<f64>, Vec<f64>)> {
    let lib = get_lib()?;
    let mut masses = vec![0.0f64; max_length as usize];
    let mut intensities = vec![0.0f64; max_length as usize];
    unsafe {
        let func: Symbol<unsafe extern "C" fn(i32, *const i32, i32, *mut f64, *mut f64, i32) -> i32> = lib.get(b"get_averaged_spectrum")
...
#[pyfunction]
fn get_instrument_count(handle: i32) -> PyResult<i32> {
    let lib = get_lib()?;
    unsafe {
        let func: Symbol<unsafe extern "C" fn(i32) -> i32> = lib.get(b"get_instrument_count")
...
#[pyfunction]
fn get_instrument_count_of_type(handle: i32, device_type: i32) -> PyResult<i32> {
    let lib = get_lib()?;
    unsafe {
        let func: Symbol<unsafe extern "C" fn(i32, i32) -> i32> = lib.get(b"get_instrument_count_of_type")
...
#[pyfunction]
fn is_open(handle: i32) -> PyResult<bool> {
    let lib = get_lib()?;
    unsafe {
        let func: Symbol<unsafe extern "C" fn(i32) -> i32> = lib.get(b"is_open")
...
#[pyfunction]
fn is_error(handle: i32) -> PyResult<bool> {
    let lib = get_lib()?;
    unsafe {
        let func: Symbol<unsafe extern "C" fn(i32) -> i32> = lib.get(b"is_error")
...
#[pyfunction]
fn in_acquisition(handle: i32) -> PyResult<bool> {
    let lib = get_lib()?;
    unsafe {
        let func: Symbol<unsafe extern "C" fn(i32) -> i32> = lib.get(b"in_acquisition")
...
#[pyfunction]
fn has_ms_data(handle: i32) -> PyResult<bool> {
    let lib = get_lib()?;
    unsafe {
        let func: Symbol<unsafe extern "C" fn(i32) -> i32> = lib.get(b"has_ms_data")
...
#[pyfunction]
fn close_raw_file(handle: i32) -> PyResult<()> {
    let lib = get_lib()?;
    unsafe {
        let func: Symbol<unsafe extern "C" fn(i32)> = lib.get(b"close_raw_file")
...
#[pyfunction]
fn get_scan_filter_meta_filters(handle: i32, scan_number: i32) -> PyResult<Vec<String>> {
    let lib = get_lib()?;
    let mut filters = vec![std::ptr::null_mut(); 32];
    unsafe {
        let func: Symbol<unsafe extern "C" fn(i32, i32, *mut *mut std::os::raw::c_char, i32) -> i32> = lib.get(b"get_scan_filter_meta_filters")
...
#[pyfunction]
fn get_scan_filter_field_free_region(handle: i32, scan_number: i32) -> PyResult<i32> {
    let lib = get_lib()?;
    unsafe {
        let func: Symbol<unsafe extern "C" fn(i32, i32) -> i32> = lib.get(b"get_scan_filter_field_free_region")
...
#[pyfunction]
fn get_scan_filter_index_to_multiple_activation_index(handle: i32, scan_number: i32) -> PyResult<i32> {
    let lib = get_lib()?;
    unsafe {
        let func: Symbol<unsafe extern "C" fn(i32, i32) -> i32> = lib.get(b"get_scan_filter_index_to_multiple_activation_index")
...
#[pyfunction]
fn get_scan_filter_compensation_volt_type(handle: i32, scan_number: i32) -> PyResult<i32> {
    let lib = get_lib()?;
    unsafe {
        let func: Symbol<unsafe extern "C" fn(i32, i32) -> i32> = lib.get(b"get_scan_filter_compensation_volt_type")
...
#[pyfunction]
fn get_scan_filter_compensation_voltage_count(handle: i32, scan_number: i32) -> PyResult<i32> {
    let lib = get_lib()?;
    unsafe {
        let func: Symbol<unsafe extern "C" fn(i32, i32) -> i32> = lib.get(b"get_scan_filter_compensation_voltage_count")
...
#[pyfunction]
fn get_scan_filter_electron_capture_dissociation(handle: i32, scan_number: i32) -> PyResult<i32> {
    let lib = get_lib()?;
    unsafe {
        let func: Symbol<unsafe extern "C" fn(i32, i32) -> i32> = lib.get(b"get_scan_filter_electron_capture_dissociation")
...
#[pyfunction]
fn get_scan_filter_electron_capture_dissociation_value(handle: i32, scan_number: i32) -> PyResult<f64> {
    let lib = get_lib()?;
    unsafe {
        let func: Symbol<unsafe extern "C" fn(i32, i32) -> f64> = lib.get(b"get_scan_filter_electron_capture_dissociation_value")
...
#[pyfunction]
fn get_scan_filter_electron_transfer_dissociation(handle: i32, scan_number: i32) -> PyResult<i32> {
    let lib = get_lib()?;
    unsafe {
        let func: Symbol<unsafe extern "C" fn(i32, i32) -> i32> = lib.get(b"get_scan_filter_electron_transfer_dissociation")
...
#[pyfunction]
fn get_scan_filter_electron_transfer_dissociation_value(handle: i32, scan_number: i32) -> PyResult<f64> {
    let lib = get_lib()?;
    unsafe {
        let func: Symbol<unsafe extern "C" fn(i32, i32) -> f64> = lib.get(b"get_scan_filter_electron_transfer_dissociation_value")
...
#[pyfunction]
fn get_scan_filter_enhanced(handle: i32, scan_number: i32) -> PyResult<i32> {
    let lib = get_lib()?;
    unsafe {
        let func: Symbol<unsafe extern "C" fn(i32, i32) -> i32> = lib.get(b"get_scan_filter_enhanced")
...
#[pyfunction]
fn get_scan_filter_higher_energy_cid(handle: i32, scan_number: i32) -> PyResult<i32> {
    let lib = get_lib()?;
    unsafe {
        let func: Symbol<unsafe extern "C" fn(i32, i32) -> i32> = lib.get(b"get_scan_filter_higher_energy_cid")
...
#[pyfunction]
fn get_scan_filter_higher_energy_cid_value(handle: i32, scan_number: i32) -> PyResult<f64> {
    let lib = get_lib()?;
    unsafe {
        let func: Symbol<unsafe extern "C" fn(i32, i32) -> f64> = lib.get(b"get_scan_filter_higher_energy_cid_value")
...
#[pyfunction]
fn get_scan_filter_multiple_photon_dissociation(handle: i32, scan_number: i32) -> PyResult<i32> {
    let lib = get_lib()?;
    unsafe {
        let func: Symbol<unsafe extern "C" fn(i32, i32) -> i32> = lib.get(b"get_scan_filter_multiple_photon_dissociation")
...
#[pyfunction]
fn get_scan_filter_multiple_photon_dissociation_value(handle: i32, scan_number: i32) -> PyResult<f64> {
    let lib = get_lib()?;
    unsafe {
        let func: Symbol<unsafe extern "C" fn(i32, i32) -> f64> = lib.get(b"get_scan_filter_multiple_photon_dissociation_value")
...
#[pyfunction]
fn get_scan_filter_pulsed_q_dissociation(handle: i32, scan_number: i32) -> PyResult<i32> {
    let lib = get_lib()?;
    unsafe {
        let func: Symbol<unsafe extern "C" fn(i32, i32) -> i32> = lib.get(b"get_scan_filter_pulsed_q_dissociation")
...
#[pyfunction]
fn get_scan_filter_pulsed_q_dissociation_value(handle: i32, scan_number: i32) -> PyResult<f64> {
    let lib = get_lib()?;
    unsafe {
        let func: Symbol<unsafe extern "C" fn(i32, i32) -> f64> = lib.get(b"get_scan_filter_pulsed_q_dissociation_value")
...
#[pyfunction]
fn get_scan_filter_source_fragmentation(handle: i32, scan_number: i32) -> PyResult<i32> {
    let lib = get_lib()?;
    unsafe {
        let func: Symbol<unsafe extern "C" fn(i32, i32) -> i32> = lib.get(b"get_scan_filter_source_fragmentation")
...
#[pyfunction]
fn get_scan_filter_source_fragmentation_info_valid(handle: i32, scan_number: i32) -> PyResult<i32> {
    let lib = get_lib()?;
    unsafe {
        let func: Symbol<unsafe extern "C" fn(i32, i32) -> i32> = lib.get(b"get_scan_filter_source_fragmentation_info_valid")
...
#[pyfunction]
fn get_scan_filter_source_fragmentation_type(handle: i32, scan_number: i32) -> PyResult<i32> {
    let lib = get_lib()?;
    unsafe {
        let func: Symbol<unsafe extern "C" fn(i32, i32) -> i32> = lib.get(b"get_scan_filter_source_fragmentation_type")
...
#[pyfunction]
fn get_scan_filter_source_fragmentation_value(handle: i32, scan_number: i32) -> PyResult<f64> {
    let lib = get_lib()?;
    unsafe {
        let func: Symbol<unsafe extern "C" fn(i32, i32) -> f64> = lib.get(b"get_scan_filter_source_fragmentation_value")
...
#[pyfunction]
fn get_scan_filter_supplemental_activation(handle: i32, scan_number: i32) -> PyResult<i32> {
    let lib = get_lib()?;
    unsafe {
        let func: Symbol<unsafe extern "C" fn(i32, i32) -> i32> = lib.get(b"get_scan_filter_supplemental_activation")
...
#[pyfunction]
fn get_scan_filter_mass_precision(handle: i32, scan_number: i32) -> PyResult<i32> {
    let lib = get_lib()?;
    unsafe {
        let func: Symbol<unsafe extern "C" fn(i32, i32) -> i32> = lib.get(b"get_scan_filter_mass_precision")
...
#[pyfunction]
fn get_scan_filter_multi_notch(handle: i32, scan_number: i32) -> PyResult<i32> {
    let lib = get_lib()?;
    unsafe {
        let func: Symbol<unsafe extern "C" fn(i32, i32) -> i32> = lib.get(b"get_scan_filter_multi_notch")
...
#[pyfunction]
fn get_scan_filter_multiplex(handle: i32, scan_number: i32) -> PyResult<i32> {
    let lib = get_lib()?;
    unsafe {
        let func: Symbol<unsafe extern "C" fn(i32, i32) -> i32> = lib.get(b"get_scan_filter_multiplex")
...
#[pyfunction]
fn get_scan_filter_unique_mass_count(handle: i32, scan_number: i32) -> PyResult<i32> {
    let lib = get_lib()?;
    unsafe {
        let func: Symbol<unsafe extern "C" fn(i32, i32) -> i32> = lib.get(b"get_scan_filter_unique_mass_count")
...
#[pyfunction]
fn get_scan_filter_param_a(handle: i32, scan_number: i32) -> PyResult<f64> {
    let lib = get_lib()?;
    unsafe {
        let func: Symbol<unsafe extern "C" fn(i32, i32) -> f64> = lib.get(b"get_scan_filter_param_a")
...
#[pyfunction]
fn get_scan_filter_param_b(handle: i32, scan_number: i32) -> PyResult<f64> {
    let lib = get_lib()?;
    unsafe {
        let func: Symbol<unsafe extern "C" fn(i32, i32) -> f64> = lib.get(b"get_scan_filter_param_b")
...
#[pyfunction]
fn get_scan_filter_param_f(handle: i32, scan_number: i32) -> PyResult<f64> {
    let lib = get_lib()?;
    unsafe {
        let func: Symbol<unsafe extern "C" fn(i32, i32) -> f64> = lib.get(b"get_scan_filter_param_f")
...
#[pyfunction]
fn get_scan_filter_param_r(handle: i32, scan_number: i32) -> PyResult<f64> {
    let lib = get_lib()?;
    unsafe {
        let func: Symbol<unsafe extern "C" fn(i32, i32) -> f64> = lib.get(b"get_scan_filter_param_r")
...
#[pyfunction]
fn get_scan_filter_param_v(handle: i32, scan_number: i32) -> PyResult<f64> {
    let lib = get_lib()?;
    unsafe {
        let func: Symbol<unsafe extern "C" fn(i32, i32) -> f64> = lib.get(b"get_scan_filter_param_v")
...
#[pyfunction]
fn get_scan_filter_scan_mode(handle: i32, scan_number: i32) -> PyResult<i32> {
    let lib = get_lib()?;
    unsafe {
        let func: Symbol<unsafe extern "C" fn(i32, i32) -> i32> = lib.get(b"get_scan_filter_scan_mode")
...
#[pyfunction]
fn get_scan_filter_accurate_mass(handle: i32, scan_number: i32) -> PyResult<i32> {
    let lib = get_lib()?;
    unsafe {
        let func: Symbol<unsafe extern "C" fn(i32, i32) -> i32> = lib.get(b"get_scan_filter_accurate_mass")
...
#[pyfunction]
fn get_scan_filter_ionization_mode(handle: i32, scan_number: i32) -> PyResult<i32> {
    let lib = get_lib()?;
    unsafe {
        let func: Symbol<unsafe extern "C" fn(i32, i32) -> i32> = lib.get(b"get_scan_filter_ionization_mode")
...
#[pyfunction]
fn get_scan_filter_lock(handle: i32, scan_number: i32) -> PyResult<i32> {
    let lib = get_lib()?;
    unsafe {
        let func: Symbol<unsafe extern "C" fn(i32, i32) -> i32> = lib.get(b"get_scan_filter_lock")
...
#[pyfunction]
fn get_scan_filter_turbo_scan(handle: i32, scan_number: i32) -> PyResult<i32> {
    let lib = get_lib()?;
    unsafe {
        let func: Symbol<unsafe extern "C" fn(i32, i32) -> i32> = lib.get(b"get_scan_filter_turbo_scan")
...
#[pyfunction]
fn get_scan_filter_corona(handle: i32, scan_number: i32) -> PyResult<i32> {
    let lib = get_lib()?;
    unsafe {
        let func: Symbol<unsafe extern "C" fn(i32, i32) -> i32> = lib.get(b"get_scan_filter_corona")
...
#[pyfunction]
fn get_scan_filter_dependent(handle: i32, scan_number: i32) -> PyResult<i32> {
    let lib = get_lib()?;
    unsafe {
        let func: Symbol<unsafe extern "C" fn(i32, i32) -> i32> = lib.get(b"get_scan_filter_dependent")
...
#[pyfunction]
fn get_scan_filter_detector_value(handle: i32, scan_number: i32) -> PyResult<f64> {
    let lib = get_lib()?;
    unsafe {
        let func: Symbol<unsafe extern "C" fn(i32, i32) -> f64> = lib.get(b"get_scan_filter_detector_value")
...
#[pyfunction]
fn get_scan_event_compensation_voltage(handle: i32, scan_number: i32) -> PyResult<i32> {
    let lib = get_lib()?;
    unsafe {
        let func: Symbol<unsafe extern "C" fn(i32, i32) -> i32> = lib.get(b"get_scan_event_compensation_voltage")
...
#[pyfunction]
fn get_scan_event_compensation_voltage_value(handle: i32, scan_number: i32) -> PyResult<f64> {
    let lib = get_lib()?;
    unsafe {
        let func: Symbol<unsafe extern "C" fn(i32, i32) -> f64> = lib.get(b"get_scan_event_compensation_voltage_value")
...
#[pyfunction]
fn get_scan_event_ms_order(handle: i32, scan_number: i32) -> PyResult<i32> {
    let lib = get_lib()?;
    unsafe {
        let func: Symbol<unsafe extern "C" fn(i32, i32) -> i32> = lib.get(b"get_scan_event_ms_order")
...
#[pyfunction]
fn get_scan_event_mass_count(handle: i32, scan_number: i32) -> PyResult<i32> {
    let lib = get_lib()?;
    unsafe {
        let func: Symbol<unsafe extern "C" fn(i32, i32) -> i32> = lib.get(b"get_scan_event_mass_count")
...
#[pyfunction]
fn get_scan_event_precursor_mass(handle: i32, scan_number: i32, index: i32) -> PyResult<f64> {
    let lib = get_lib()?;
    unsafe {
        let func: Symbol<unsafe extern "C" fn(i32, i32, i32) -> f64> = lib.get(b"get_scan_event_precursor_mass")
...
fn get_scan_event_activation_type(handle: i32, scan_number: i32, index: i32) -> PyResult<i32> {
    let lib = get_lib()?;
    unsafe {
        let func: Symbol<unsafe extern "C" fn(i32, i32, i32) -> i32> = lib.get(b"get_scan_event_activation_type")
...
fn get_scan_event_collision_energy(handle: i32, scan_number: i32, index: i32) -> PyResult<f64> {
    let lib = get_lib()?;
    unsafe {
        let func: Symbol<unsafe extern "C" fn(i32, i32, i32) -> f64> = lib.get(b"get_scan_event_collision_energy")
...
fn get_scan_filter_ultra(handle: i32, scan_number: i32) -> PyResult<i32> {
    let lib = get_lib()?;
    unsafe {
        let func: Symbol<unsafe extern "C" fn(i32, i32) -> i32> = lib.get(b"get_scan_filter_ultra")
...
#[pyfunction]
fn get_scan_filter_wideband(handle: i32, scan_number: i32) -> PyResult<i32> {
    let lib = get_lib()?;
    unsafe {
        let func: Symbol<unsafe extern "C" fn(i32, i32) -> i32> = lib.get(b"get_scan_filter_wideband")
...
#[pyfunction]
fn get_scan_filter_polarity(handle: i32, scan_number: i32) -> PyResult<i32> {
    let lib = get_lib()?;
    unsafe {
        let func: Symbol<unsafe extern "C" fn(i32, i32) -> i32> = lib.get(b"get_scan_filter_polarity")
...
#[pyfunction]
fn get_scan_filter_ms_order(handle: i32, scan_number: i32) -> PyResult<i32> {
    let lib = get_lib()?;
    unsafe {
        let func: Symbol<unsafe extern "C" fn(i32, i32) -> i32> = lib.get(b"get_scan_filter_ms_order")
...
#[pyfunction]
fn get_scan_filter_mass_analyzer(handle: i32, scan_number: i32) -> PyResult<i32> {
    let lib = get_lib()?;
    unsafe {
        let func: Symbol<unsafe extern "C" fn(i32, i32) -> i32> = lib.get(b"get_scan_filter_mass_analyzer")
...
#[pyfunction]
fn get_scan_filter_detector(handle: i32, scan_number: i32) -> PyResult<i32> {
    let lib = get_lib()?;
    unsafe {
        let func: Symbol<unsafe extern "C" fn(i32, i32) -> i32> = lib.get(b"get_scan_filter_detector")
...
#[pyfunction]
fn get_scan_filter_scan_data(handle: i32, scan_number: i32) -> PyResult<i32> {
    let lib = get_lib()?;
    unsafe {
        let func: Symbol<unsafe extern "C" fn(i32, i32) -> i32> = lib.get(b"get_scan_filter_scan_data")
...
#[pyfunction]
fn get_trailer_extra_count(handle: i32) -> PyResult<i32> {
    let lib = get_lib()?;
    unsafe {
        let func: Symbol<unsafe extern "C" fn(i32) -> i32> = lib.get(b"get_trailer_extra_count")
...
#[pyfunction]
fn get_status_log_values(handle: i32, scan_number: i32) -> PyResult<Vec<String>> {
    let lib = get_lib()?;
    let mut buffer = vec![0u8; 8192];
    unsafe {
        let func: Symbol<unsafe extern "C" fn(i32, i32, *mut u8, i32) -> i32> = lib.get(b"get_status_log_values")
...
#[pyfunction]
fn get_status_log_header(handle: i32) -> PyResult<Vec<String>> {
    let lib = get_lib()?;
    let mut buffer = vec![0u8; 8192];
    unsafe {
        let func: Symbol<unsafe extern "C" fn(i32, *mut u8, i32) -> i32> = lib.get(b"get_status_log_header")
...
#[pyfunction]
fn get_status_log_values_for_rt(handle: i32, rt: f64) -> PyResult<Vec<String>> {
    let lib = get_lib()?;
    let mut buffer = vec![0u8; 16384];
    unsafe {
        let func: Symbol<unsafe extern "C" fn(i32, f64, *mut u8, i32) -> i32> = lib.get(b"get_status_log_values_for_rt")
...
#[pyfunction]
fn get_status_log_count(handle: i32) -> PyResult<i32> {
    let lib = get_lib()?;
    unsafe {
        let func: Symbol<unsafe extern "C" fn(i32) -> i32> = lib.get(b"get_status_log_count")
...
#[pyfunction]
fn get_trailer_extra_values(handle: i32, scan_number: i32) -> PyResult<Vec<String>> {
    let lib = get_lib()?;
    let mut buffer = vec![0u8; 8192];
    unsafe {
        let func: Symbol<unsafe extern "C" fn(i32, i32, *mut u8, i32) -> i32> = lib.get(b"get_trailer_extra_values")
...
fn get_trailer_extra_header(handle: i32) -> PyResult<Vec<String>> {
    ...
    let mut buffer = vec![0u8; 8192];
    unsafe {
        let func: Symbol<unsafe extern "C" fn(i32, *mut u8, i32) -> i32> = lib.get(b"get_trailer_extra_header")
...
#[pyfunction]
fn get_file_description(handle: i32) -> PyResult<String> {
    let lib = get_lib()?;
    let mut buffer = vec![0u8; 1024];
    unsafe {
        let func: Symbol<unsafe extern "C" fn(i32, *mut u8, i32) -> i32> = lib.get(b"get_file_description")
...
#[pyfunction]
fn get_modified_date(handle: i32) -> PyResult<String> {
    let lib = get_lib()?;
    let mut buffer = vec![0u8; 256];
    unsafe {
        let func: Symbol<unsafe extern "C" fn(i32, *mut u8, i32) -> i32> = lib.get(b"get_modified_date")
...
#[pyfunction]
fn get_who_created_logon(handle: i32) -> PyResult<String> {
    let lib = get_lib()?;
    let mut buffer = vec![0u8; 256];
    unsafe {
        let func: Symbol<unsafe extern "C" fn(i32, *mut u8, i32) -> i32> = lib.get(b"get_who_created_logon")
...
#[pyfunction]
fn get_who_modified_id(handle: i32) -> PyResult<String> {
    let lib = get_lib()?;
    let mut buffer = vec![0u8; 256];
    unsafe {
        let func: Symbol<unsafe extern "C" fn(i32, *mut u8, i32) -> i32> = lib.get(b"get_who_modified_id")
...
#[pyfunction]
fn get_who_modified_logon(handle: i32) -> PyResult<String> {
    let lib = get_lib()?;
    let mut buffer = vec![0u8; 256];
    unsafe {
        let func: Symbol<unsafe extern "C" fn(i32, *mut u8, i32) -> i32> = lib.get(b"get_who_modified_logon")
...
fn get_sample_barcode(handle: i32) -> PyResult<String> {
    ...
    let mut buffer = vec![0u8; 1024];
    unsafe {
        let func: Symbol<unsafe extern "C" fn(i32, *mut u8, i32) -> i32> = lib.get(b"get_sample_barcode")
...
#[pyfunction]
fn get_sample_id(handle: i32) -> PyResult<String> {
    let lib = get_lib()?;
    let mut buffer = vec![0u8; 1024];
    unsafe {
        let func: Symbol<unsafe extern "C" fn(i32, *mut u8, i32) -> i32> = lib.get(b"get_sample_id")
...
#[pyfunction]
fn get_sample_name(handle: i32) -> PyResult<String> {
    let lib = get_lib()?;
    let mut buffer = vec![0u8; 1024];
    unsafe {
        let func: Symbol<unsafe extern "C" fn(i32, *mut u8, i32) -> i32> = lib.get(b"get_sample_name")
...
#[pyfunction]
fn get_sample_vial(handle: i32) -> PyResult<String> {
    let lib = get_lib()?;
    let mut buffer = vec![0u8; 256];
    unsafe {
        let func: Symbol<unsafe extern "C" fn(i32, *mut u8, i32) -> i32> = lib.get(b"get_sample_vial")
...
#[pyfunction]
fn get_sample_comment(handle: i32) -> PyResult<String> {
    let lib = get_lib()?;
    let mut buffer = vec![0u8; 1024];
    unsafe {
        let func: Symbol<unsafe extern "C" fn(i32, *mut u8, i32) -> i32> = lib.get(b"get_sample_comment")
...
#[pyfunction]
fn get_instrument_axis_label_x(handle: i32) -> PyResult<String> {
    let lib = get_lib()?;
    let mut buffer = vec![0u8; 1024];
    unsafe {
        let func: Symbol<unsafe extern "C" fn(i32, *mut u8, i32) -> i32> = lib.get(b"get_instrument_axis_label_x")
...
#[pyfunction]
fn get_instrument_axis_label_y(handle: i32) -> PyResult<String> {
    let lib = get_lib()?;
    let mut buffer = vec![0u8; 1024];
    unsafe {
        let func: Symbol<unsafe extern "C" fn(i32, *mut u8, i32) -> i32> = lib.get(b"get_instrument_axis_label_y")
...
#[pyfunction]
fn get_instrument_flags(handle: i32) -> PyResult<String> {
    let lib = get_lib()?;
    let mut buffer = vec![0u8; 1024];
    unsafe {
        let func: Symbol<unsafe extern "C" fn(i32, *mut u8, i32) -> i32> = lib.get(b"get_instrument_flags")
...
#[pyfunction]
fn get_instrument_units(handle: i32) -> PyResult<i32> {
    let lib = get_lib()?;
    unsafe {
        let func: Symbol<unsafe extern "C" fn(i32) -> i32> = lib.get(b"get_instrument_units")
...
#[pyfunction]
fn get_instrument_is_valid(handle: i32) -> PyResult<bool> {
    let lib = get_lib()?;
    unsafe {
        let func: Symbol<unsafe extern "C" fn(i32) -> i32> = lib.get(b"get_instrument_is_valid")
...
#[pyfunction]
fn get_instrument_has_accurate_mass_precursors(handle: i32) -> PyResult<bool> {
    let lib = get_lib()?;
    unsafe {
        let func: Symbol<unsafe extern "C" fn(i32) -> i32> = lib.get(b"get_instrument_has_accurate_mass_precursors")
...
#[pyfunction]
fn get_instrument_is_tsq_quantum_file(handle: i32) -> PyResult<bool> {
    let lib = get_lib()?;
    unsafe {
        let func: Symbol<unsafe extern "C" fn(i32) -> i32> = lib.get(b"get_instrument_is_tsq_quantum_file")
...
#[pyfunction]
fn select_instrument(handle: i32, device_type: i32, device_number: i32) -> PyResult<()> {
    let lib = get_lib()?;
    unsafe {
        let func: Symbol<unsafe extern "C" fn(i32, i32, i32)> = lib.get(b"select_instrument")
...
#[pyfunction]
fn get_instrument_method_count(handle: i32) -> PyResult<i32> {
    let lib = get_lib()?;
    unsafe {
        let func: Symbol<unsafe extern "C" fn(i32) -> i32> = lib.get(b"get_instrument_method_count")
...
#[pyfunction]
fn get_instrument_method(handle: i32, index: i32) -> PyResult<String> {
    let lib = get_lib()?;
    let mut buffer = vec![0u8; 128 * 1024]; // 128KB buffer for method text
    unsafe {
        let func: Symbol<unsafe extern "C" fn(i32, i32, *mut u8, i32) -> i32> = lib.get(b"get_instrument_method")
...
#[pyfunction]
fn get_autosampler_tray_index(handle: i32) -> PyResult<i32> {
    let lib = get_lib()?;
    unsafe {
        let func: Symbol<unsafe extern "C" fn(i32) -> i32> = lib.get(b"get_autosampler_tray_index")
...
#[pyfunction]
fn get_autosampler_vial_index(handle: i32) -> PyResult<i32> {
    let lib = get_lib()?;
    unsafe {
        let func: Symbol<unsafe extern "C" fn(i32) -> i32> = lib.get(b"get_autosampler_vial_index")
...
#[pyfunction]
fn get_autosampler_tray_name(handle: i32) -> PyResult<String> {
    let lib = get_lib()?;
    let mut buffer = vec![0u8; 1024];
    unsafe {
        let func: Symbol<unsafe extern "C" fn(i32, *mut u8, i32) -> i32> = lib.get(b"get_autosampler_tray_name")
...
#[pyfunction]
fn get_autosampler_tray_shape(handle: i32) -> PyResult<i32> {
    let lib = get_lib()?;
    unsafe {
        let func: Symbol<unsafe extern "C" fn(i32) -> i32> = lib.get(b"get_autosampler_tray_shape")
...
#[pyfunction]
fn get_autosampler_vials_per_tray(handle: i32) -> PyResult<i32> {
    let lib = get_lib()?;
    unsafe {
        let func: Symbol<unsafe extern "C" fn(i32) -> i32> = lib.get(b"get_autosampler_vials_per_tray")
...
#[pyfunction]
fn get_autosampler_vials_per_tray_x(handle: i32) -> PyResult<i32> {
    let lib = get_lib()?;
    unsafe {
        let func: Symbol<unsafe extern "C" fn(i32) -> i32> = lib.get(b"get_autosampler_vials_per_tray_x")
...
#[pyfunction]
fn get_autosampler_vials_per_tray_y(handle: i32) -> PyResult<i32> {
    let lib = get_lib()?;
    unsafe {
        let func: Symbol<unsafe extern "C" fn(i32) -> i32> = lib.get(b"get_autosampler_vials_per_tray_y")
...
#[pyfunction]
fn get_sample_instrument_method_file(handle: i32) -> PyResult<String> {
    let lib = get_lib()?;
    let mut buffer = vec![0u8; 1024];
    unsafe {
        let func: Symbol<unsafe extern "C" fn(i32, *mut u8, i32) -> i32> = lib.get(b"get_sample_instrument_method_file")
...
#[pyfunction]
fn get_sample_injection_volume(handle: i32) -> PyResult<f64> {
    let lib = get_lib()?;
    unsafe {
        let func: Symbol<unsafe extern "C" fn(i32) -> f64> = lib.get(b"get_sample_injection_volume")
...
#[pyfunction]
pub fn get_scan_filter_mass_count(handle: i32, scan_number: i32) -> PyResult<i32> {
    let lib = get_lib()?;
    unsafe {
        let func: Symbol<unsafe extern "C" fn(i32, i32) -> i32> = lib.get(b"get_scan_filter_mass_count\0")
            .map_err(|e| PyErr::new::<pyo3::exceptions::PyRuntimeError, _>(format!("get function get_scan_filter_mass_count: {}", e)))?;
        Ok(func(handle, scan_number))
    }
}

#[pyfunction]
pub fn get_scan_filter_mass_range_count(handle: i32, scan_number: i32) -> PyResult<i32> {
    let lib = get_lib()?;
    unsafe {
        let func: Symbol<unsafe extern "C" fn(i32, i32) -> i32> = lib.get(b"get_scan_filter_mass_range_count\0")
            .map_err(|e| PyErr::new::<pyo3::exceptions::PyRuntimeError, _>(format!("get function get_scan_filter_mass_range_count: {}", e)))?;
        Ok(func(handle, scan_number))
    }
}

#[pyfunction]
pub fn get_scan_filter_source_fragmentation_info_count(handle: i32, scan_number: i32) -> PyResult<i32> {
    let lib = get_lib()?;
    unsafe {
        let func: Symbol<unsafe extern "C" fn(i32, i32) -> i32> = lib.get(b"get_scan_filter_source_fragmentation_info_count\0")
            .map_err(|e| PyErr::new::<pyo3::exceptions::PyRuntimeError, _>(format!("get function get_scan_filter_source_fragmentation_info_count: {}", e)))?;
        Ok(func(handle, scan_number))
    }
}

#[pyfunction]
pub fn get_scan_filter_scan_type_index(handle: i32, scan_number: i32) -> PyResult<i64> {
    let lib = get_lib()?;
    unsafe {
        let func: Symbol<unsafe extern "C" fn(i32, i32) -> i64> = lib.get(b"get_scan_filter_scan_type_index\0")
            .map_err(|e| PyErr::new::<pyo3::exceptions::PyRuntimeError, _>(format!("get function get_scan_filter_scan_type_index: {}", e)))?;
        Ok(func(handle, scan_number))
    }
}

#[pyfunction]
pub fn get_scan_filter_multi_state_activation(handle: i32, scan_number: i32) -> PyResult<i32> {
    let lib = get_lib()?;
    unsafe {
        let func: Symbol<unsafe extern "C" fn(i32, i32) -> i32> = lib.get(b"get_scan_filter_multi_state_activation\0")
            .map_err(|e| PyErr::new::<pyo3::exceptions::PyRuntimeError, _>(format!("get function get_scan_filter_multi_state_activation: {}", e)))?;
        Ok(func(handle, scan_number))
    }
}

#[pyfunction]
pub fn get_scan_filter_photo_ionization(handle: i32, scan_number: i32) -> PyResult<i32> {
    let lib = get_lib()?;
    unsafe {
        let func: Symbol<unsafe extern "C" fn(i32, i32) -> i32> = lib.get(b"get_scan_filter_photo_ionization\0")
            .map_err(|e| PyErr::new::<pyo3::exceptions::PyRuntimeError, _>(format!("get function get_scan_filter_photo_ionization: {}", e)))?;
        Ok(func(handle, scan_number))
    }
}

#[pyfunction]
pub fn get_scan_filter_sector_scan(handle: i32, scan_number: i32) -> PyResult<i32> {
    let lib = get_lib()?;
    unsafe {
        let func: Symbol<unsafe extern "C" fn(i32, i32) -> i32> = lib.get(b"get_scan_filter_sector_scan\0")
            .map_err(|e| PyErr::new::<pyo3::exceptions::PyRuntimeError, _>(format!("get function get_scan_filter_sector_scan: {}", e)))?;
        Ok(func(handle, scan_number))
    }
}

#[pyfunction]
pub fn get_scan_event_precursor_range_validity(handle: i32, scan_number: i32, index: i32) -> PyResult<i32> {
    let lib = get_lib()?;
    unsafe {
        let func: Symbol<unsafe extern "C" fn(i32, i32, i32) -> i32> = lib.get(b"get_scan_event_precursor_range_validity\0")
            .map_err(|e| PyErr::new::<pyo3::exceptions::PyRuntimeError, _>(format!("get function get_scan_event_precursor_range_validity: {}", e)))?;
        Ok(func(handle, scan_number, index))
    }
}

#[pyfunction]
pub fn get_scan_event_is_multiple_activation(handle: i32, scan_number: i32, index: i32) -> PyResult<i32> {
    let lib = get_lib()?;
    unsafe {
        let func: Symbol<unsafe extern "C" fn(i32, i32, i32) -> i32> = lib.get(b"get_scan_event_is_multiple_activation\0")
            .map_err(|e| PyErr::new::<pyo3::exceptions::PyRuntimeError, _>(format!("get function get_scan_event_is_multiple_activation: {}", e)))?;
        Ok(func(handle, scan_number, index))
    }
}

#[pyfunction]
pub fn get_scan_event_energy_valid(handle: i32, scan_number: i32, index: i32) -> PyResult<i32> {
    let lib = get_lib()?;
    unsafe {
        let func: Symbol<unsafe extern "C" fn(i32, i32, i32) -> i32> = lib.get(b"get_scan_event_energy_valid\0")
            .map_err(|e| PyErr::new::<pyo3::exceptions::PyRuntimeError, _>(format!("get function get_scan_event_energy_valid: {}", e)))?;
        Ok(func(handle, scan_number, index))
    }
}

#[pyfunction]
pub fn get_scan_event_source_fragmentation_info(handle: i32, scan_number: i32, index: i32) -> PyResult<f64> {
    let lib = get_lib()?;
    unsafe {
        let func: Symbol<unsafe extern "C" fn(i32, i32, i32) -> f64> = lib.get(b"get_scan_event_source_fragmentation_info\0")
            .map_err(|e| PyErr::new::<pyo3::exceptions::PyRuntimeError, _>(format!("get function get_scan_event_source_fragmentation_info: {}", e)))?;
        Ok(func(handle, scan_number, index))
    }
}

#[pyfunction]
pub fn get_scan_event_mass_calibrator(handle: i32, scan_number: i32, index: i32) -> PyResult<f64> {
    let lib = get_lib()?;
    unsafe {
        let func: Symbol<unsafe extern "C" fn(i32, i32, i32) -> f64> = lib.get(b"get_scan_event_mass_calibrator\0")
            .map_err(|e| PyErr::new::<pyo3::exceptions::PyRuntimeError, _>(format!("get function get_scan_event_mass_calibrator: {}", e)))?;
        Ok(func(handle, scan_number, index))
    }
}

#[pyfunction]
pub fn get_scan_event_mass_range_low(handle: i32, scan_number: i32, index: i32) -> PyResult<f64> {
    let lib = get_lib()?;
    unsafe {
        let func: Symbol<unsafe extern "C" fn(i32, i32, i32) -> f64> = lib.get(b"get_scan_event_mass_range_low\0")
            .map_err(|e| PyErr::new::<pyo3::exceptions::PyRuntimeError, _>(format!("get function get_scan_event_mass_range_low: {}", e)))?;
        Ok(func(handle, scan_number, index))
    }
}

#[pyfunction]
pub fn get_scan_event_mass_range_high(handle: i32, scan_number: i32, index: i32) -> PyResult<f64> {
    let lib = get_lib()?;
    unsafe {
        let func: Symbol<unsafe extern "C" fn(i32, i32, i32) -> f64> = lib.get(b"get_scan_event_mass_range_high\0")
            .map_err(|e| PyErr::new::<pyo3::exceptions::PyRuntimeError, _>(format!("get function get_scan_event_mass_range_high: {}", e)))?;
        Ok(func(handle, scan_number, index))
    }
}

#[pyfunction]
pub fn get_scan_event_source_fragmentation_mass_range_low(handle: i32, scan_number: i32, index: i32) -> PyResult<f64> {
    let lib = get_lib()?;
    unsafe {
        let func: Symbol<unsafe extern "C" fn(i32, i32, i32) -> f64> = lib.get(b"get_scan_event_source_fragmentation_mass_range_low\0")
            .map_err(|e| PyErr::new::<pyo3::exceptions::PyRuntimeError, _>(format!("get function get_scan_event_source_fragmentation_mass_range_low: {}", e)))?;
        Ok(func(handle, scan_number, index))
    }
}

#[pyfunction]
pub fn get_scan_event_source_fragmentation_mass_range_high(handle: i32, scan_number: i32, index: i32) -> PyResult<f64> {
    let lib = get_lib()?;
    unsafe {
        let func: Symbol<unsafe extern "C" fn(i32, i32, i32) -> f64> = lib.get(b"get_scan_event_source_fragmentation_mass_range_high\0")
            .map_err(|e| PyErr::new::<pyo3::exceptions::PyRuntimeError, _>(format!("get function get_scan_event_source_fragmentation_mass_range_high: {}", e)))?;
        Ok(func(handle, scan_number, index))
    }
}
#[pyfunction]
...
fn native_fisher_py_backend(m: &Bound<'_, PyModule>) -> PyResult<()> {
    ...
    m.add_function(wrap_pyfunction!(get_scan_filter_mass_count, m)?)?;
    m.add_function(wrap_pyfunction!(get_scan_filter_mass_range_count, m)?)?;
    m.add_function(wrap_pyfunction!(get_scan_filter_source_fragmentation_info_count, m)?)?;
    m.add_function(wrap_pyfunction!(get_scan_filter_scan_type_index, m)?)?;
    m.add_function(wrap_pyfunction!(get_scan_filter_multi_state_activation, m)?)?;
    m.add_function(wrap_pyfunction!(get_scan_filter_photo_ionization, m)?)?;
    m.add_function(wrap_pyfunction!(get_scan_filter_sector_scan, m)?)?;
    m.add_function(wrap_pyfunction!(get_scan_event_precursor_range_validity, m)?)?;
    m.add_function(wrap_pyfunction!(get_scan_event_is_multiple_activation, m)?)?;
    m.add_function(wrap_pyfunction!(get_scan_event_energy_valid, m)?)?;
    m.add_function(wrap_pyfunction!(get_scan_event_source_fragmentation_info, m)?)?;
    m.add_function(wrap_pyfunction!(get_scan_event_mass_calibrator, m)?)?;
    m.add_function(wrap_pyfunction!(get_scan_event_mass_range_low, m)?)?;
    m.add_function(wrap_pyfunction!(get_scan_event_mass_range_high, m)?)?;
    m.add_function(wrap_pyfunction!(get_scan_event_source_fragmentation_mass_range_low, m)?)?;
    m.add_function(wrap_pyfunction!(get_scan_event_source_fragmentation_mass_range_high, m)?)?;
