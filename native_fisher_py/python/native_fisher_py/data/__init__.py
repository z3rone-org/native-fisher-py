...
class DataClass(object):
    ...
    def auto_sampler_information(self):
        from . import auto_sampler_information
        auto_sampler_information

    @property
    def common_core_data_object(self):
        from . import common_core_data_object
        common_core_data_object
    ...
    def error_log_entry(self):
        from . import error_log_entry
        error_log_entry

    @property
    def file_error(self):
        from . import file_error
        file_error
    ...
    @property
    def filter_accurate_mass(self):
        from . import filter_accurate_mass
        filter_accurate_mass

    @property
    def ft_average_options(self):
        from . import ft_average_options
        ft_average_options

    @property
    def peak_options(self):
        from . import peak_options
        peak_options

    @property
    def raw_file_classification(self):
        from . import raw_file_classification
        raw_file_classification

    @property
    def scan_dependent_details(self):
        from . import scan_dependent_details
        scan_dependent_details
    ...
    @property
    def sequence_file_writer(self):
        from . import sequence_file_writer
        sequence_file_writer

    @property
    def sequence_info(self):
        from . import sequence_info
        sequence_info

    @property
    def source_fragmentation_info_valid_type(self):
        from . import source_fragmentation_info_valid_type
        source_fragmentation_info_valid_type

    @property
    def tolerance_units(self):
        from . import tolerance_units
        tolerance_units

    @property
    def tray_shape(self):
        from . import tray_shape
        tray_shape
    ...
    @property
    def filter_enums(self):
        from . import filter_enums as f
        f
